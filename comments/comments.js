...
.controller('commentsCtrl', function($scope,$resource,$routeParams) {
        ...
        var Comments=$resource("https://agile-brook-75395.herokuapp.com/api/posts/:newsId");
        ...
        $scope.submit=function(){
            if($scope.comment.author&&$scope.comment.body){
                var Comments2=$resource("https://agile-brook-75395.herokuapp.com/api/posts/:newsId/comments",{newsId:$scope.newsId},{upvote:{method:'PUT'}});
